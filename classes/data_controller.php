...
class data_controller extends \core_customfield\data_controller {
    ...
    public function instance_form_validation(array $data, array $files) : array {
        ...
        if (($maxlength > 0) && ($maxlength < \core_text::strlen($data[$elementname]))) {
            $errors[$elementname] = get_string('errormaxlength', 'customfield_textformat', $maxlength);
        }
        return $errors;
    }
     ...
     * Contrary to normal customfield_text, this plugin formats the default text beforehand.
     * This allows usage of filter & shortcodes in default value (eg name of category {categoryname}).
     *
     * @return mixed
     */
